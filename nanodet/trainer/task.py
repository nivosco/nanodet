...
class TrainingTask(LightningModule):
    ...
    def validation_epoch_end(self, validation_step_outputs):
        ...
        for res in validation_step_outputs:
            results.update(res)
        all_results = results #gather_results(results) if self.trainer.use_ddp else results
        if all_results:
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        for res in test_step_outputs:
            results.update(res)
        all_results = results#ather_results(results) if self.trainer.use_ddp else results
        if all_results:
